...
namespace Ccao_big_homework
{
    ...
    public partial class WorkWindow :Window
    {
        ...
        {
            this.Opacity = 0;
            DoubleAnimation OpercityAnimation = new DoubleAnimation(0.01, 1.00, new Duration(TimeSpan.FromSeconds(0.3)));
            ...
            ta1.From = new Thickness(20, -100, 10, 139);
            ta1.To = new Thickness(20, 26, 10, 13);
            ta1.Duration = TimeSpan.FromSeconds(0.4);
            ...
            ta2.Duration = TimeSpan.FromSeconds(0.4);
            ...
            ta3.Duration = TimeSpan.FromSeconds(0.4);
